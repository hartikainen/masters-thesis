...
% Hardware threads are static, meaning that they cannot adapt to the dynamic changes of the workload. Also, the hardware threads cannot be migrated between the computing units, and thus binding the computation to hardware threads forces the computation to be done on the specific computing unit. This is why
