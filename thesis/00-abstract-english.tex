...
We show that, with extended queue disciplines and support for modeling parallelism, resource network methodology is a viable approach for modeling complex packet processing systems. The main contributions of our work are three-fold. First, we have extended the toolset of an existing in-house simulator software to enable modeling of customized queue disciplines needed to model complex multiprocessor system-on-chip system network processing units. Secondly, we have instrumented and measured the characteristics of a customized network processing system. Lastly, we have built a simulation model based on a modern network processing unit and ran experiments to validate the proper model behaviour.
