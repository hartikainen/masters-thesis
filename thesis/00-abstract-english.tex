...
In this thesis, we investigate the use of measurement, simulation, and modeling methods for the performance analysis of packet processing systems, and more precisely Network Processing Units (NPU). The packet scheduling mechanisms of the NPU devices play the key role for guaranteeing the latency and throughput requirements. The quality of service requirements, together with parallelized packet processing, require careful design of the simulator software to mimic the correct behavior of the system under study.
