...
A thing to note about the simulation software is their parallelization. Managing the events of and monitoring during thethe simulation, addition to the challenging in parallel computing itself, make the scaling of simulation software extremely complex.~\cite{Fujimoto:1990:PDE}
...
% TODO:
% - tässä voisi miettiä jotain korkeamman tason jaottelua erityyppisten simulaationsoftien välille
% - sitten voisi antaa konkreettisia esimerkkejä kustakin
% - voisi pohtia erilaisten mallinnusmekanismien ilmaisuvoimaa (primääriä käyttökohdetta, simulaationopeutta, mallinnustehokkuutta, jne.)
