...
%   \centering
%   \includegraphics[width=.8\linewidth]{pipeline-crop.pdf}
%   \caption{1a}
%   \label{fig:pipeline}
% \end{subfigure}%
% \begin{subfigure}{.5\textwidth}
%   \centering
%   \includegraphics[width=.8\linewidth]{parallel-crop.pdf}
%   \caption{1b}
%   \label{fig:parallel}
% \end{subfigure}
% \begin{subfigure}{.5\textwidth}
%   \centering
%   \includegraphics[width=.8\linewidth]{parallel-pipeline-crop.pdf}
%   \caption{1b}
%   \label{fig:parallel-pipeline}
% \end{subfigure}
% \begin{subfigure}{.5\textwidth}
%   \centering
%   \includegraphics[width=.8\linewidth]{pipeline-parallel-crop.pdf}
%   \caption{1b}
%   \label{fig:pipeline-parallel}
% \end{subfigure}
% \caption{plots of....}
