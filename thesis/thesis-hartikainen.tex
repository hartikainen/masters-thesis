...
\usepackage[style=numeric, backend=biber, firstinits=true]{biblatex}
...
\input{03-distributed-parallel-stream-computing.tex}

\input{04-system-simulation.tex}

\input{05-performance-simulation-environment.tex}

\input{06-example-simulation-model.tex}

\input{07-model-evaluation.tex}
